/**
 * 历史一次性脚本（2026-06-20 失败补退，已被启动迁移 refund_failed_v1 取代，仅留档）。
 * 金额口径注意：脚本编写时积分为旧汇率（¥0.035/积分）；2026-09-01 起 1 积分 = ¥1，
 * 库内金额已由 migration_credits_v2 换算，本脚本的 ×0.035 折算输出仅对历史备份库有意义。
 */
