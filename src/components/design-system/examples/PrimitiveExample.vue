...
<template>
  <div class="ds-stack">
    ...
    <U.SidebarProvider v-else-if="family === 'sidebar'" class="min-h-0"><U.SidebarMenu><U.SidebarMenuItem><U.SidebarMenuButton :is-active="true">创作工作台</U.SidebarMenuButton></U.SidebarMenuItem><U.SidebarMenuItem><U.SidebarMenuButton>作品库</U.SidebarMenuButton></U.SidebarMenuItem></U.SidebarMenu></U.SidebarProvider>
